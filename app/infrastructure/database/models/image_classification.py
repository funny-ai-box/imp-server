...
class ImageClassification(db.Model):
    ...
    config_id = Column(Integer, ForeignKey("image_classification_configs.id"), nullable=False, comment="使用的配置ID")
    ...
    config = relationship("ImageClassificationConfig", back_populates="classifications")
