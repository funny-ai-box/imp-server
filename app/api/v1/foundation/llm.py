...
@llm_providers_bp.route("/get_provider", methods=["POST"])
@auth_required
def get_provider():
    """获取特定大模型平台信息"""
    # 验证请求数据
...
@llm_providers_bp.route("/create_provider", methods=["POST"])
@auth_required
def create_provider():
    """创建新的大模型平台(用户自己配置)"""
    # 验证请求数据
...
@llm_providers_bp.route("/update_provider", methods=["POST"])
@auth_required
def update_provider():
    """更新大模型平台信息"""
    # 验证请求数据
...
@llm_providers_bp.route("/delete_provider", methods=["POST"])
@auth_required
def delete_provider():
    """删除大模型平台"""
    # 验证请求数据
...
@llm_providers_bp.route("/provider_types", methods=["GET"])
@auth_required
